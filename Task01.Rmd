...
Compared with the results of the preliminary test, this is not the same method we identified previously (DE.2704500.A). While A was the best method for the single problem type we tested on, this does not hold true when the scope of problems is broadened.

If we had to choose a second best algorithm, our results would point us to DE.2704500.D, which had the next lowest mean loss after E.
