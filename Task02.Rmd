...
test_metrics
```
The test metrics tell us that our model achieves an F1 score of 0.767 on the test set, close to the cross-validated estimate of 0.787. This tells us that the model generalizes well.
